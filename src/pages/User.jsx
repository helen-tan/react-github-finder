...
function User() {
  ...
  useEffect(() => {
    ...
    const getUserData = async() => {
      const userData = await getUser(params.login) // Pass the login params from the URL
      dispatch({
        type: 'GET_USER',
        payload: userData
      })

      const userRepoData = await getUserRepos(params.login) // Pass the login params from the URL
      dispatch({
        type: 'GET_REPOS',
